...
func (s Float32Set) Intersection(another Float32Set) interface{} {
	intersection := NewFloat32()
	for i := range s {
...
func (s Float32Set) Union(another Float32Set) interface{} {
	union := NewFloat32()
...
// Intersection returns a set, that is the intersection of two other sets
func (s Float64Set) Intersection(another Float64Set) interface{} {
	intersection := NewFloat64()
	for i := range s {
		if another.Contains(i) {
			intersection.Add(i)
		}
...
// Union returns a set containing the union of sets
func (s Float64Set) Union(another Float64Set) interface{} {
	union := NewFloat64()
...
// Intersection returns a set, that is the intersection of two other sets
func (s Int32Set) Intersection(another Int32Set) interface{} {
	intersection := NewInt32()
	for i := range s {
		if another.Contains(i) {
			intersection.Add(i)
		}
...
// Union returns a set containing the union of sets
func (s Int32Set) Union(another Int32Set) interface{} {
	union := NewInt32()
...
// Intersection returns a set, that is the intersection of two other sets
func (s Int16Set) Intersection(another Int16Set) interface{} {
	intersection := NewInt16()
	for i := range s {
		if another.Contains(i) {
			intersection.Add(i)
		}
...
// Union returns a set containing the union of sets
func (s Int16Set) Union(another Int16Set) interface{} {
	union := NewInt16()
...
// Intersection returns a set, that is the intersection of two other sets
func (s IntSet) Intersection(another IntSet) interface{} {
	intersection := NewInt()
	for i := range s {
		if another.Contains(i) {
			intersection.Add(i)
...
// Union returns a set containing the union of sets
func (s IntSet) Union(another IntSet) interface{} {
	union := NewInt()
...
// Intersection returns a set, that is the intersection of two other sets
func (s Uint64Set) Intersection(another Uint64Set) interface{} {
	intersection := NewUint64()
	for i := range s {
		if another.Contains(i) {
			intersection.Add(i)
		}
...
// Union returns a set containing the union of sets
func (s Uint64Set) Union(another Uint64Set) interface{} {
	union := NewUint64()
...
// Intersection returns a set, that is the intersection of two other sets
func (s Uint32Set) Intersection(another Uint32Set) interface{} {
	intersection := NewUint32()
	for i := range s {
		if another.Contains(i) {
			intersection.Add(i)
		}
...
// Union returns a set containing the union of sets
func (s Uint32Set) Union(another Uint32Set) interface{} {
	union := NewUint32()
...
// Intersection returns a set, that is the intersection of two other sets
func (s Uint16Set) Intersection(another Uint16Set) interface{} {
	intersection := NewUint16()
	for i := range s {
		if another.Contains(i) {
			intersection.Add(i)
		}
...
// Union returns a set containing the union of sets
func (s Uint16Set) Union(another Uint16Set) interface{} {
	union := NewUint16()
...
// Intersection returns a set, that is the intersection of two other sets
func (s UintSet) Intersection(another UintSet) interface{} {
	intersection := NewUint()
	for i := range s {
		if another.Contains(i) {
			intersection.Add(i)
		}
...
// Union returns a set containing the union of sets
func (s UintSet) Union(another UintSet) interface{} {
	union := NewUint()
